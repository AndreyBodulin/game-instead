...
toilet = room {
  ...
  pic = 'assets/img/Ivan/tolkan.png';
...
room {
  ...
  pic = 'assets/img/Ivan/planet.png';
...
room {
  nam = 'disembark';
  disp = 'Высаживаемся!';
  pic = 'assets/img/Ivan/bg-pusheen.png';
...
ready_pusheen = room {
  disp = 'Вы прошли игру!';
  pic = 'assets/img/Ivan/ready-pusheen.gif';
}: with {
  obj {
    dsc = [[{Переиграть?}]];
    act = function()
