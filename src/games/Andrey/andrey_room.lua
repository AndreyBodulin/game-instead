room { 
	...
	pic = 'assets/img/Andrey/космодром.png';
	way = {
...
room { 
	...
	pic = 'assets/img/Andrey/корабль.png';
	way = {
...
room { 
	...
	pic = 'assets/img/Andrey/Капитанский_мостик.png';
	obj = {'пилот'};
	way = {
...
room { 
	...
	pic = 'assets/img/Andrey/оружейная.png';
	obj = {'пистолет'};
	way = {
		path {"Вернуться на космодром", "космодром"},
	};
...
room { 
	...
	pic = 'assets/img/Andrey/туалет.png';
	obj = {'туалет_Андрей'};
	way = {
		path {"Вернуться на корабль", "корабль"},
	};
...
room { 
	...
	pic = 'assets/img/Andrey/Столовая.png';
	obj = {'начальник'},
	way = {
		path {"Вернуться на космодром", "космодром"},
	};
...
room { 
	...
	pic = 'assets/img/Andrey/Склад.png';
	way = {
		path {"Вернуться на корабль", "корабль"},
	};
	obj = {'механик-инженер'};
...
room { 
	...
	pic = 'assets/img/Andrey/Блок_воды.png';
	way = {
		path {"Вернуться на корабль", "корабль"},
	};
	enter = function(s)
...
room { 
	...
	pic = 'assets/img/Andrey/поражение.png';
}
...
room { 
	...
	pic = 'assets/img/Andrey/победа.png';
	way = {
