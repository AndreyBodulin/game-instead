...
------------------------
document = obj {
  disp = 'документ'..fmt.img('assets/img/Sergey/book.png');
  dsc = function(s)
    p [[На столе лежит {документ} неизвестного содержания...^^]];
    p(fmt.tab('50%', 'center')..fmt.img('assets/img/Sergey/document.png'));
  end;
...
coffeeBreak = room {
  ...
  pic = 'assets/img/Sergey/coffee.gif';
...
painAttack = room {
  painAttackImages = {
    'assets/img/Sergey/pain-1.png',
    'assets/img/Sergey/pain-2.png',
    'assets/img/Sergey/pain-3.png',
  };
  timeValue = 0;
  disp = function(s)
...
traveledToToilet = room {
  toiletImages = {
    'assets/img/Sergey/toilet-1.png',
    'assets/img/Sergey/toilet-2.png',
    'assets/img/Sergey/toilet-3.png',
    'assets/img/Sergey/toilet-4.jpg',
  };
  timeValue = 0;
  disp = function(s)
...
traitorVolodya = room {
  volodyaImages = {
    'assets/img/Sergey/volodya-1.jpg',
    'assets/img/Sergey/volodya-2.jpg',
    'assets/img/Sergey/volodya-3.jpg',
    'assets/img/Sergey/volodya-4.jpg',
    'assets/img/Sergey/volodya-5.jpg',
  };
  bug = 0;
  disp = function(s)
...
helperBulka = room {
  bulkaImages = {
    'assets/img/Sergey/bulka-1.png',
    'assets/img/Sergey/bulka-2.png',
    'assets/img/Sergey/bulka-3.png',
    'assets/img/Sergey/bulka-4.png',
    'assets/img/Sergey/bulka-5.png',
  };
  bug = 0;
  disp = function(s)
...
roomList = room {
  ...
  exit = function(s)
    ...
    if timestamp == getTimeStamp(1, 'д') or timestamp < getTimeStamp(1, 'д') then
      snd.music('assets/sounds/Sergey/terror.mp3', 0);
    end;
...
room {
  ...
  onenter = function()
    take "статусы"
    snd.music('assets/sounds/Sergey/theme.mp3', 0);
    snapshots:make();
  end;
}: with {
  obj {
...
ready = room {
  ...
  pic = 'assets/img/Sergey/ready.gif';
  enter = function()
    snd.music('assets/sounds/Sergey/happy.mp3', 1);
    snapshots:remove();
    drop "статусы";
  end;
  exit = function()
...
fail = room {
  ...
  pic = 'assets/img/Sergey/fail2.gif';
  enter = function()
    snd.music('assets/sounds/Sergey/fail.mp3', 1);
  end;
  exit = function()
    snd.stop_music()
  end;
