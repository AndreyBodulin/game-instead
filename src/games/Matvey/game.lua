...
room {
	...
	pic = 'assets/img/Matvey/background.png';
}
...
room {
  ...
  pic = 'assets/img/Matvey/operator.png';
  way = { path {'Начать игру', 'центр'} };
  enter = function()
    take 'статусы_матвей';
    snd.music('assets/sounds/Matvey/interstellar.mp3', 0);
  end;
}
...
room {
  ...
  pic = 'assets/img/Matvey/command-center.png';
  isInit = false;
  way = {
...
room {
  ...
  pic = 'assets/img/Matvey/room1.png';
	way = {
...
room {
  ...
  pic = 'assets/img/Matvey/room2.png';
	way = {
		path {'Вернуться в командный центр', 'центр'},
    path {'Главный зал', 'зал'},
    path {'Левое крыло', 'левое крыло'},
...
room {
  ...
  pic = 'assets/img/Matvey/room3.png';
	way = {
		path {'Вернуться в командный центр', 'центр'},
    path {'Главный зал', 'зал'},
	};
...
room {
  ...
  pic = 'assets/img/Matvey/room4.jpg';
	way = {
		path {'Вернуться в командный центр', 'центр'},
    path {'Офисное помещение', 'офис'},
    path {'Право крыло', 'правое крыло'},
...
room {
  ...
  pic = 'assets/img/Matvey/room6.jpg';
	way = {
		path {'Вернуться в командный центр', 'центр'},
    path {'Офисное помещение', 'офис'},
    path {'Левое крыло', 'левое крыло'},
...
room {
  ...
  pic = 'assets/img/Matvey/room5.png';
	way = {
		path {'Вернуться в командный центр', 'центр'},
    path {'Офисное помещение', 'офис'},
    path {'Левое крыло', 'левое крыло'},
...
room {
  ...
  pic = 'assets/img/Matvey/dudes.png';
	way = {
...
room {
  ...
  pic = 'assets/img/Matvey/launch.png';
  obj = {
    'охлаждение',
    'процедуры',
    'связь',
